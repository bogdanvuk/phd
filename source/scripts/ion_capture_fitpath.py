...
runs = [
    {"fn": '../data/searchprob/ion_fitpath_vanilla.js', "params": {
        'search_function': 0}
    },
    {"fn": '../data/searchprob/ion_fitpath_metropolis.js', "params": {
        'return_prob': 0}
    },
    {"fn": '../data/searchprob/ion_fitpath_metropolis_rp.js', "params": {
        'return_prob': 0.0005}
    },
    {"fn": '../data/searchprob/ion_fitpath_hereboy.js', "params": {
        'search_prob': 2e-3,
        'search_function': 2}
    }
    ]
