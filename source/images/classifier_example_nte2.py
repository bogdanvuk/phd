...
fig << text_vals(r"$\mathbf{x}=[\mathtt{4BE4},\mathtt{523D}]$ \\[2pt] $C = 2$", alignment='left').align(ports['inst_inp_bus'][-1], cur().n())
...
fig << text_vals(r"$\mathtt{1396b5d0}$").align(nte['mul'][0].n(1.0), cur().s())
fig << text_vals(r"$\mathtt{03140281}$").align(nte['mul'][1].s(1.0), cur().n())
fig << text_vals(r"$\mathtt{16AAB851}$").align(nte['add0'][0].n(0.7), cur().s())

fig << text_vals(r"$\mathtt{16AA}$").align(nte[r"$\leq$"].w(1) - p(1.5,0), cur().s(1.0))
fig << text_vals(r"$\mathtt{14DF}$").align(nte[r"$\leq$"].w(2) - p(1.5,0), cur().e(0.5))

fig << text_vals("$\mathtt{80}$").align(nte['MUX1'].s(1), cur().n(1.1, -0.2))
fig << text_vals("$\mathtt{0}$").align(nte['MUX1'].s(2), cur().n(-0.1, -0.2))
fig << text_vals(r"\textbf{false}").align(nte[r"$\leq$"].n(0.5), cur().s(0.5))
fig << text_vals("$\mathtt{0}$").align(nte[r"$\leq$"].e(0.5), cur().s())
...
fig << text_vals(r"$\mathbf{x}=[\mathtt{4BE4},\mathtt{523D}]$ \\[2pt] $C = 2$", alignment='left').align(ports['inst_out'][-1], cur().n(1.0))
